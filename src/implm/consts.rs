...
pub mod cpooltypes {
	pub const C_CLASS: u8 = 7;
	pub const C_FIELDREF: u8 = 9;
	pub const C_METHODREF: u8 = 10;
	pub const C_INTERFACE_METHODREF: u8 = 11;
	pub const C_STRING: u8 = 8;
	pub const C_INTEGER: u8 = 3;
	pub const C_FLOAT: u8 = 4;
	pub const C_LONG: u8 = 5;
	pub const C_DOUBLE: u8 = 6;
	pub const C_NAME_AND_TYPE: u8 = 12;
	pub const C_UTF8: u8 = 1;
	pub const C_METHODHANDLE: u8 = 15;
	pub const C_METHODTYPE: u8 = 16;
	pub const C_INVOKEDYNAMIC: u8 = 18;
}
...
pub mod frames {
	pub const F_SAME: u8 = 0;
	pub const F_SAME_LOCALS_1_STACK: u8 = 64;
	pub const F_SAME_LOCALS_1_STACK_EXT: u8 = 247;
	pub const F_CHOP: u8 = 248;
	pub const F_SAME_EXT: u8 = 251;
	pub const F_APPEND: u8 = 252;
	pub const F_FULL: u8 = 255;
}

pub mod vtypes {
	pub const V_TOP: u8 = 0;
	pub const V_INTEGER: u8 = 1;
	pub const V_FLOAT: u8 = 2;
	pub const V_LONG: u8 = 4;
	pub const V_DOUBLE: u8 = 3;
	pub const V_NULL: u8 = 5;
	pub const V_UNINITIALIZED_THIS: u8 = 6;
	pub const V_OBJECT: u8 = 7;
	pub const V_UNINITIALIZED: u8 = 8;
}
